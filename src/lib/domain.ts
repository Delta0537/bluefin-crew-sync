...
// Statuses that mean a job is actively consuming crew right now.
export const ACTIVE_JOB_STATUSES: JobStatus[] = ["Upcoming", "Ongoing", "Cross Utilization"];
...
export const JOB_STATUS_TONE: Record<JobStatus, string> = {
  ...
  Bidding: "bg-muted text-muted-foreground border-border",
...
export const TIME_OFF_TONE: Record<TimeOffType, string> = {
  PTO: "bg-primary/15 text-primary border-primary/30",
  Sick: "bg-warning/20 text-warning-foreground dark:text-warning border-warning/40",
  Medical: "bg-warning/20 text-warning-foreground dark:text-warning border-warning/40",
  Vacation: "bg-primary/15 text-primary border-primary/30",
  Bereavement: "bg-muted text-muted-foreground border-border",
  "Light Duty": "bg-accent text-accent-foreground border-border",
